                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="butttonadd">
                            <a class="btn btn-primary" href="{{route('department.index')}}" style="margin-bottom:10px; width:100%">Back to User Index</a>
                        </div>
                        ...
                        <form action="{{ route('department.update',[$department->id]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <a href="{{$department->departmentpdf}}" class="btn btn-primary">View Old File</a>
                                </div>
                                <div class="col-sm-8">
