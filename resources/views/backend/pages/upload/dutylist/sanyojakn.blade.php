...
@section('title')
Sector Sanyojak’s Nari Satsang Duty list
@endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between" style="padding-bottom:5px;">
                    <h5 class="mb-sm-0">Sector Sanyojak’s Nari Satsang Duty list</h5>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="col-lg-12">
                    <form action="" class="d-flex" style="margin-bottom: 5px">
                        ...
                        <div style="display: flex; justify-content:space-between; margin:0px 5px">
                            ...
                            <a href="{{route('sanyojak.nari.duty')}}" class="btn btn-danger">
