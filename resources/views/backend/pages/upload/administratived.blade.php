    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between" style="padding-bottom:5px;">
                    <h5 class="mb-sm-0">Administrative Contact List</h5>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
                ...
                <div class="col-lg-12">
                    <form action="" class="d-flex" style="margin-bottom: 5px">
                        ...
                        <div style="display: flex; justify-content:space-between; margin:0px 5px">
                            ...
                            <a href="{{route('administrationDetails')}}" class="btn btn-danger">
            ...
            <div class="text-center" style="display: flex; justify-content: center; align-items: center;margin-bottom: 10px" >
                <form action="" >
                    <input type="text" name="mukhi" value="mukhi" hidden>
                    <button class="btn btn-primary" style="font-size: 12px; margin:1px ">
                        Area Mukhi
                    </button>
                </form>
                <form action="" >
                    <input type="text" name="sanyojak" value="sanyojak" hidden>
                    <button class="btn btn-primary" style="font-size: 12px; margin:1px ">
                        Sector Sanyojak
                    </button>
                </form>
                <form action="" >
                    <input type="text" name="sewadal" value="sewadal" hidden>
                    <button class="btn btn-primary" style="font-size: 12px; margin:1px ">
                        Sewadal Sanchalak
                    </button>
                </form>
                <form action="" >
                    <input type="text" name="kshetriya" value="kshetriya" hidden>
                    <button class="btn btn-primary" style="font-size: 12px; margin:1px ">
                        Kshetriya Sanchalak
                    </button>
                </form>
                            ...
                            <div class="flex-grow-1">
                                <table class="table">
                                    <div style="display:flex;align-items:center">
                                        ...
                                        <div>
                                            <h6 class="header-p" style="color:rgb(2, 2, 83);font-weight:700">Mahatma Name</h6>
                                    ...
                                    <div style="display:flex;align-items:center">
                                        ...
                                        <div>
                                            <h6 class="header-p" style="color:rgb(2, 2, 83);font-weight:700">Mahatma Contact</h6>
